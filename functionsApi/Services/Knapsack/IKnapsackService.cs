...
namespace Services.KnapsackService
{
    ...
    {
        Task<ServiceResponse<List<Track>>> SolveKnapsack(DesiredLengths desiredLengths, List<Track> tracks, string userId);
        ...
        Task<ServiceResponse<CustomPlaylistRecord>> CreateCustomPlaylist(List<Track> tracks, string userId);
