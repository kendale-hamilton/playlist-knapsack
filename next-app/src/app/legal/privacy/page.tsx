        ...
        <Card className="bg-gray-800 border border-gray-600">
          ...
          <CardBody className="space-y-6 text-gray-200 leading-relaxed">
            <section>
              ...
              <p>
                Playlist Knapsack collects the following types of information:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-2 text-gray-200">
                <li>
                  <strong className="text-white">Spotify Account Data:</strong>{" "}
                  When you connect your Spotify account, we access your
                  playlists, music library, and profile information through
                  Spotify&apos;s API
                </li>
                <li>
                  <strong className="text-white">Usage Data:</strong> We collect
                  information about how you use our service, including which
                  playlists you process and the duration targets you set
                </li>
                <li>
                  <strong className="text-white">Technical Data:</strong> We may
                  collect technical information such as IP addresses, browser
                  type, and device information for service optimization
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2 text-gray-200">
                ...
                <li>
                  To process your playlist data and generate new playlists of
                  specific durations
                </li>
            ...
            <section>
              ...
              <p>
                We do not store your actual music files or Spotify credentials.
                We may store:
              </p>
              <ul className="list-disc pl-6 space-y-2 mt-2 text-gray-200">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2 text-gray-200">
                ...
                <li>
                  <strong className="text-white">Revocation:</strong> You can
                  revoke Spotify access through your Spotify account settings
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                Our service integrates with Spotify&apos;s API. Please review
                Spotify&apos;s privacy policy to understand how they handle your
                data. We are not responsible for Spotify&apos;s data practices.
              </p>
            </section>
